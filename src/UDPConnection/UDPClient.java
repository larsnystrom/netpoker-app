...
public class UDPClient {
	...
	public UDPClient(InetAddress hostAddress, int port) {
		...
		//endast fšr testning av chatten - skall tas bort
		//------------------------------------------------
		...
		while (true) {
			...
			try {
				...
				ClientRecieverThread receiver = new ClientRecieverThread(dp, ackmanager, myTurn, chat);
				receiver.start();
