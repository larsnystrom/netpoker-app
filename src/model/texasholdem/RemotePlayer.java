...
import model.texasholdem.RemoteClient;
...
public class RemotePlayer {
	 ...
	 */
	public RemotePlayer(String name, int cash, RemoteClient client) {
		this.name = name;
		this.cash = cash;
		this.client = client;
	...
	private RemotePlayer(String name, int cash, RemoteClient client, Hand hand) {
		this.name = name;
		this.cash = cash;
		this.client = client;
		this.hand = hand;
	 ...
	 */
	public RemotePlayer publicClone() {
		RemotePlayer clone = new RemotePlayer(name, cash, null);
	...
	public static RemotePlayer deserialize(String player, String delimiter) {
		...
		RemotePlayer des = new RemotePlayer(playerName, startingCash, null, hand);
